...
const SharedFolder = () => {
    ...
    const handleSubmit = e =>{
        ...
        axiosInstance.
        post(`sharedfolder/uploadfile`, form_data)
            .then(res => {
                console.log(res);
                closeDialog();
    ...
    return (
        ...
        <div style={{marginTop: "30px"}}>
            ...
            >
                <DialogContent>
                    <Typography varient="h3" style={{margin: 30}}>
                ...
                <DialogActions>
                    ...
                    <Button type="submit" onClick={closeDeleteDialog} variant="contained" color="primary">
                        Close
                    </Button>
                </DialogActions>
            </Dialog>
